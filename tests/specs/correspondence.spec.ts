...
test.describe('STAGE - Correspondence Testing Suite', () => {
    test('Complete Correspondence test flow', async ({ page }) => {
        ...
        const correspondence = new correspondencePanel(page);
        ...
        try {
            ...
            await test.step('Search for member and test Correspondence', async () => {
