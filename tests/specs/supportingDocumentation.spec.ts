...
test.describe('STAGE - Supporting Documentation Testing Suite', () => {
    test('Complete Supporting Documentation test flow', async ({ page }) => {
        ...
        try {
            ...
            await test.step('Search for member and test Supporting Documentation', async () => {
                ...
                //verify data in Supporting Documentation panel:
                //await labs.verifySupportingDocumentationData();
            });
        } catch (err) {
