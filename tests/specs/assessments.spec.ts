...
test.describe('STAGE - Assessments Testing Suite', () => {
    test('Complete Assessments test flow', async ({ page }) => {
        ...
        try {
            ...
            await test.step('Search for member and test Assessments', async () => {
