...
test.describe('STAGE - Resource Library Testing Suite', () => {
    test('Complete Resource Library test flow', async ({ page }) => {
        ...
        try {
            ...
            await test.step('Search for member and test Resource Library', async () => {
