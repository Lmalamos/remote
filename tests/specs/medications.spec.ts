...
test.describe('STAGE - Medications Testing Suite', () => {
    test('Complete Medications test flow', async ({ page }) => {
        ...
        const medications = new medicationsPanel(page);
        ...
        try {
            ...
            await test.step('Search for member and test Medications', async () => {
                ...
                //verify data in Medications panel:
                //await labs.verifyMedicationsData();
            });
        } catch (err) {
