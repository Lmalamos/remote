...
test.describe('STAGE - Manage Outcome Reasons Testing Suite', () => {
    test('Complete Manage Outcome Reasons test flow', async ({ page }) => {
        test.setTimeout(500000);

        const login = new loginPage(page);
        const nav = new navigationPage(page);
        const manageOutcomeReason = new manageOutcomeReasons(page);
        ...
        try {
            ...
            await test.step('Test Manage Outcome Reasons', async () => {
                ...
                await manageOutcomeReason.manageOutcomeReasons();
            });
        } catch (err) {
